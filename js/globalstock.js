$(document).ready(function () {
    ...
    $(".globalStock #container .schChartArea .chartSection .tabsArea .chartsum_tabs li").click(function () {
        $(".globalStock #container .schChartArea .chartSection .tabsArea .chartsum_tabs li").removeClass("active");
        $(this).addClass("active");
        $(".tabsArea .tab_content").hide();
...
$(function () {
    ...
    function doSearch(obj) {
        ...
        for (var tic in search_ticker_list) {
            ...
            if (ticker == search) {
                // ticker 일치
                match_li = $('<li><a href="/op_stocks/summary/' + tic + '"><span class="schCode">' + tic + '</span><span class="schList">' + search_ticker_list[tic].name + '</span></a></li>');
                continue;
            }
            if ((ticker + search_ticker_list[tic].name).toUpperCase().indexOf(search) >= 0) {
                find_lis.push($('<li><a href="/op_stocks/summary/' + tic + '"><span class="schCode">' + tic + '</span><span class="schList">' + search_ticker_list[tic].name + '</span></a></li>'));
            }
        }
        if (match_li !== null) {
            ul.append(match_li);
